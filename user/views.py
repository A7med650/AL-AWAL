...
def home(request):
    ...
    context = footer_and_category()
    context.update({'publisher': publishers, })
...
def publisher(request):
    ...
    context = footer_and_category()
    context.update({'publishers': publishers, })
...
def sign_up(request):
    ...
    if request.method == "POST" and request.POST.get(
            'next') == 'Sign up' and Check.valid and Check.valid_email and Check.valid_password:
        ...
        message = render_to_string('val.html', {
            'user': user,
            'domain': domain,
