...
urlpatterns = [
    ...
    path('incrementbook/<int:id_>', views.incrementcart, name='incrementbooks'),
    path('decrementbook/<int:id_>', views.decrementcart, name='decrementbooks'),

    path('activate/<uidb64>/<token>', views.activate, name='activate'),
    path('forget-password/', views.forgetpass, name='forget-password'),
    path('set-new-password/<uidb64>/<token>',
         views.complete_password_reset, name='set-new-password'),
